...
export default [
  // Vendored third-party code (noVNC, xterm, shadcn/ui generated primitives) and
  // build output are not linted: src/components/ui/** is regenerated by
  // `npx shadcn add`, not hand-written, and ships an unused `React` import that
  // this project's JSX-runtime config doesn't need.
  { ignores: ["dist/**", "public/**", "node_modules/**", "e2e-report/**", "e2e-results/**", "src/components/ui/**"] },
