  ...
  return (
    <div className="card divide-y divide-anthracite-600">
      <div className="grid grid-cols-4 gap-2 px-4 py-2 text-xs font-medium text-anthracite-400">
        <span>Pool</span><span>Type</span><span>Capacité</span><span>Disponible</span>
      </div>
      {pools.length === 0 && <div className="px-4 py-3 text-sm text-anthracite-400">Aucun pool sur ce nœud.</div>}
      {pools.map((p) => (
