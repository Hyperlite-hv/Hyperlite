...
**Non ajoutées** : A-05, A-11, A-12, A-13, A-14, A-15, A-30, A-33 (nécessitent le backend), A-24, A-26 (page conteneur), A-27 (champs cachés exposés : partiellement — `jusqu_a` du journal, filtres des tâches, ports), A-34, A-36 à A-40.
...
- **Faille de sécurité B1 non corrigée** : un observateur peut ouvrir un terminal SSH dans une VM (`app/routers/vms/console.py:142`). Correctif backend séparé, en attente de votre accord (A-30).
